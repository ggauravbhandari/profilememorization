         ...
         <table class="table table-striped table-bordered tablelist" id="userlist">
            <thead>
               <tr>
                  ...
                  <th scope="col"  class="desktop"><?php echo lang('dob') ?></th>
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td  class="mobile-flex" data-header="<?php echo lang('profile_name') ?>"><a href="<?php echo site_url('/').'?profile='.$post_val->profile_url ?>" class="theme-text-color" target="_blank"><?php echo $post_val->profile_name ?></a></td>
                  <td  class="mobile-flex" data-header="<?php echo lang('name') ?>"><?php echo $post_val->first_name.' '.$post_val->last_name ?></td>
                  
                  <td  class="mobile-flex" data-header="<?php echo lang('dob') ?>"><?php echo date_ymdformate($post_val->dob) ?></td>
