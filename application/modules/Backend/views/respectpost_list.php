                    ...
                    <table class="table table-striped table-bordered" id="userlist">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="<?php echo ($post_val->respect_image!='') ? UploadStorage::url( $post_val->respect_image ) : base_url('assets/frontend/uploads/').get_defaultimage()->profile_img ?>" width="70" alt="<?php echo $post_val->name ?>" onerror="this.onerror=null; this.src='<?php echo base_url('assets/frontend/uploads/').get_defaultimage()->profile_img ?>'"/></td>

                                <td><?php echo $post_val->comment ?></td>
                                ...
                                <td>
                                    ...
                                    <a  href="<?php echo site_url('admin/updateactivestatus/respect_post/'.$post_val->id.'/1') ?>" class="btn-primary btn"><?php echo lang('active') ?></a>
                                    <?php }else{ ?>
                                    <a  href="<?php echo site_url('admin/updateactivestatus/respect_post/'.$post_val->id.'/2') ?>" class="btn-danger btn"><?php echo lang('deactive') ?></a>
                                    <?php } ?>
                                    </div>
                                </td>
                            </tr>
