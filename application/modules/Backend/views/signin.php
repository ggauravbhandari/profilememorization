            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <?php } ?>
                        <form action="<?php echo site_url('admin/loginpost') ?>" method="post">
                        ...
                        <div class="form-floating mb-4">
                            <input type="password" class="form-control" id="floatingPassword" placeholder="<?php echo lang('password') ?>" name="password">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <a href="<?php echo site_url('admin/forgotpassword') ?>"><?php echo lang('forgotpassword') ?></a>
                        </div>
