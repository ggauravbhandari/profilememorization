...
if($_SERVER['HTTP_HOST'] =='127.0.0.1:8000'){
	//Localhost Url
	 $config['base_url'] = 'http://memorization.local/';
}elseif($_SERVER['HTTP_HOST'] =='memorization.opusinfotech.in'){
	//Localhost Url
	$config['base_url'] = $root;
}else{		
	//Live Url
	// $config['base_url'] = $root;
	$config['base_url'] = 'https://profile.memorisation.co.uk/';
}
// $config['base_url'] = 'http://127.0.0.1:8000/edsa-memorisation/';
