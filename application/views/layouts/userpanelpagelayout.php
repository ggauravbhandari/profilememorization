   ...
   <body>
      ...
      <div class="content">
         ...
         <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
            <a href="<?php echo site_url('user') ?>" class="navbar-brand d-flex d-lg-none me-4">
            ...
            <div class="navbar-nav align-items-center ms-auto">
               <div class="nav-item dropdown">
                  ...
                  <span class="d-none d-lg-inline-flex">Hi <?php echo ($this->session->userdata('frontuserdetail')['user_name']) ?>,</span>
                  </a>
                  <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                     <!-- <a href="#" class="dropdown-item"><?php echo lang('menu4') ?> </a> -->
                     <!-- <a href="#" class="dropdown-item"><?php echo lang('menu5') ?></a> -->
                     <a href="<?php echo site_url('user/logout') ?>" class="dropdown-item"><?php echo lang('menu3') ?></a>
                  </div>
               </div>
            </div>
         </nav>
      ...
      <script>
         $(document).ready(function(){
            ...
            // $("#checkgroup_wardenlimit").on('change',
