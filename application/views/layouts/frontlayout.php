...
<head>
    ...
    <script type="text/javascript">
        $('body').on("click",".add-comment-btn-section",function(){
            var scrolled = $(this).parents('.modal-content').height();
            // scrolled=740;
            var parent_div = $(this).parent();
            console.log($('#section-2').offset().top,scrolled,$('.modal-body').height());
        ...
        $('body').on("click",".add-comment-btn-section-respect",function(){
            // var scrolled = $(this).parents('.modal-content').height();
            // scrolled=740;
            var parent_div = $(this).parent();
            // console.log($('#section-2').offset().top,scrolled,$('.modal-body').height());
...
<body>
    <div class="top-header d-none d-md-flex justify-content-between align-item-center">
        <div class="logo-top-header">
            <a href="<?php echo 'https://memorisation.co.uk/';//site_url('/') ?>" target="_blank"><img
            ...
            <div class="right-part d-table">
                ...
                <div class="menu-btn d-table mx-2 float-start">
                    ...
                    <nav class="sidebar">
                        <ul>
                            <li>
                                <a href="<?php echo 'https://memorisation.co.uk/';//site_url('/') ?>"><span>
                                <img src="<?php echo base_url('assets/frontend/') ?>images/Menu.png"></span><b>
                                <?php echo lang('memorisation')?><b></a>
                            </li>
                            <?php
                           //echo get_user_plan().user_profilecount();
                           if($this->session->userdata('frontuserdetail')){
                            if(familygroupcount() && familygroupcount()['ids']==1){
                           ?>
                            <li class="active"><a href="<?php echo site_url('familymember').'/'.familygroupcount()['id'] ?>"
                                    class="menu-close"><span><img
                                            src="<?php echo base_url('assets/frontend/') ?>images/Edit Profile.svg"></span><b><?php echo lang('menu_profile_group')?></b></a>
                            </li>
                            <?php }else{ ?>
                ...
                <div class="row">
                    ...
                    <div class="col-4 nav-foot tab-parent">
                        ...
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation"><a href="https://memorisation.co.uk/blogs/">Blog</a></li>
                    ...
                    <div class="col-4 nav-foot social-foot">
                        <h4>Social Media</h4>
                        <ul>
                            <li><a href="https://www.instagram.com/memorisationuk/"><img src="<?php echo site_url('assets/frontend/') ?>images/face-foot.png">
                                    Facebook</a></li>
                            <li><a href="https://www.facebook.com/memorisationuk/"><img src="<?php echo site_url('assets/frontend/') ?>images/insta-foot.png">
                                    Instagram</a></li>
                            <li><a href="https://www.tiktok.com/@memorisationuk"><img src="<?php echo site_url('assets/frontend/') ?>images/foot-twit.png">
                                    Tiktok</a></li>
                        </ul>
                    </div>
                    <div class="col-12">
                        <div class="copy-text">
                            <p>ⒸMemorisation All rights reserved | <a href="https://memorisation.co.uk/terms-and-conditions/">Terms and Conditions</a> Apply</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?php echo site_url('profileupdate') ?>" method="post"  id="userprofile-form" novalidate="novalidate"
                        enctype="multipart/form-data" class="profileform">
                        <input type="hidden" name="family_group_id" value="<?php echo $currect_group_id ?>">
                        <div class="row">
                                ...
                                <div class="col-12 col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <div  style="width:55%;float:left;padding-top: 10px;" class="minput form-label">
                                            <?php echo site_url() ?>/?profile=<br><span class="font-small-red-normal"><?php echo lang('profile_name_character_text') ?></span></div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="mt-3">
                                    ...
                                    <span class="image-backdisplay-new" style="display: none">
                                        <!-- <img src="<?php //echo site_url() ?>assets/frontend/uploads/<?php //echo get_defaultimage()->background_img ?>" width="100px;"> -->
                                    </span>
                                    <!-- </div> -->
                                </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mt-3">
                                    ...
                                    <input type="text" name="address_1" placeholder="<?php echo lang('address_1') ?>"
                                        class="form-control" value="<?php echo ($this->session->flashdata('signuppopup')) ? $this->session->flashdata('signuppopup')['address_1'] : '' ?>">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="mt-3">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mt-3">
                                    ...
                                    <input type="text" name="city" placeholder="<?php echo lang('city') ?>"
                                        class="form-control" value="<?php echo ($this->session->flashdata('signuppopup')) ? $this->session->flashdata('signuppopup')['city'] : '' ?>">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="mt-3">
                                    ...
                                    <input type="text" name="postcode" placeholder="<?php echo lang('postcode') ?>"
                                        class="form-control" value="<?php echo ($this->session->flashdata('signuppopup')) ? $this->session->flashdata('signuppopup')['postcode'] : '' ?>">
                                </div>
                            </div>
                            <!-- <div class="col-12 col-md-12">
                           <div class="mb-3">
    ...
    <div class="modal fade" id="verifysuccessModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="alert alert-success verifysuccessModal-sucess hide"></div>
                    <div class="alert alert-danger verifysuccessModal-error hide"></div>
                    <?php if($this->session->flashdata('error')){
                     echo '<div class="alert-danger p-3">'.$this->session->flashdata('error').'</div>';
                     } ?>
                    <?php if($this->session->flashdata('success')){
                     echo '<div class="alert-success p-3">'.$this->session->flashdata('success').'</div>';
                     } ?>
                     <div style="text-align: center;"><a href="javascrip:;" style="display:inline-block;text-decoration:none;font-weight:bold;font-size:16px;margin-top:5px;padding:15px 20px;background-color:#90a792;color:#fff;" data-bs-dismiss="modal" aria-label="Close" data-bs-toggle="modal" data-bs-target="#login-modal"><?php echo lang('login') ?></a></div>
                </div>
                <div class="modal-footer"></div>
            </div>
        </div>
                            ...
                            <div class="col-12" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="user_table" style="border-radius:50px">
                                        <option value="users" selected>Admin</option>
                                        ...
                                        <div class="col-12 col-md-12">
                                            <div class="mb-3">
                                                <input type="text" placeholder="Name" class="form-control"
                                                    id="exampleInputname_com" aria-describedby="emailHelp" name="name"
                                        ...
                                        <div class="col-12 col-md-12">
                                            <div class="mb-3">
                                                <input type="email" placeholder="Email" class="form-control"
                                                    id="exampleInputEmail1_clm" aria-describedby="emailHelp" name="email"
                                ...
                                <form class="collapse" id="comment-featurepost" method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-12">
                                            <div class="mb-3">
                                                <input type="text" placeholder="Name" class="form-control"
                                                    id="exampleInputname_cfm" aria-describedby="emailHelp" name="name"
                                                    value="<?php if(checkauth() && get_frontauthuser('warden_user_id')>0) { echo user_detail(get_frontauthuser('warden_user_id'))->firstname.' '.user_detail(get_frontauthuser('warden_user_id'))->lastname; }elseif(checkauth()){
                                                        echo user_detail(get_frontauthuser('user_id'))->firstname.' '.user_detail(get_frontauthuser('user_id'))->lastname;
                                                    }else{echo '';} ?>" required>
                                            </div>
                                        ...
                                        <div class="col-12 col-md-12">
                                            <div class="mb-3">
                                                <input type="email" placeholder="Email" class="form-control"
                                                    id="exampleInputEmail1_cfm" aria-describedby="emailHelp" name="email"
                                                    value="<?php if(checkauth() && get_frontauthuser('warden_user_id')>0) { echo user_detail(get_frontauthuser('warden_user_id'))->email; }elseif(checkauth()){
                                                        echo user_detail(get_frontauthuser('user_id'))->email;
                                                    }else{echo '';} ?>" required>
                                            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <form class="collapse" id="comment-timeline" method="post"
                            ...
                            <input type="hidden" name="post_type" id="post_type" />
                            <input type="hidden" name="postid" id="postid" />
                            <input type="hidden" name="user_id" value="<?php if(checkauth() && get_frontauthuser('warden_user_id')>0) { echo get_frontauthuser('warden_user_id'); }elseif(checkauth()){ echo get_frontauthuser('user_id');}else{echo '0';} ?>" />
                            <div class="row">
                                <div class="col-12 col-md-12">
                                    <div class="mb-3">
                                        <input type="text" placeholder="Name" class="form-control" id="exampleInputname_ctm" aria-describedby="emailHelp" name="name" value="<?php if(checkauth() && get_frontauthuser('warden_user_id')>0) { echo user_detail(get_frontauthuser('warden_user_id'))->firstname.' '.user_detail(get_frontauthuser('warden_user_id'))->lastname; }elseif(checkauth()){
                                                        echo user_detail(get_frontauthuser('user_id'))->firstname.' '.user_detail(get_frontauthuser('user_id'))->lastname;
                                                    }else{echo '';} ?>" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-12">
                                    <div class="mb-3">
                                        <input type="email" placeholder="Email" class="form-control"
                                            id="exampleInputEmail1_ctlm" aria-describedby="emailHelp" name="email" value="<?php if(checkauth() && get_frontauthuser('warden_user_id')>0) { echo user_detail(get_frontauthuser('warden_user_id'))->email; }elseif(checkauth()){
                                                        echo user_detail(get_frontauthuser('user_id'))->email;
                                                    }else{echo '';} ?>"
                                            required>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        <textarea class="form-control" placeholder="Leave Comment"
                                            id="exampleFormControlTextarea1" rows="3" data-emojiable="true" data-emoji-input="unicode" name="comment"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class=" d-flex">
                            ...
                            <div class="col-12 col-md-12">
                                <div class="mb-3">
                                    <input type="text" placeholder="Album Title" class="form-control required"
                                        name="title" id="exampleInputEmail22" aria-describedby="emailHelp" require maxlength="40">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
    ...
    <!-- warden assign -->
    <div class="modal fade" id="warden-assign-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><?php echo lang('warden_assign') ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="<?php echo site_url('groupwarden-mapping') ?>" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    <select class="form-control" required name="warden_id">
                                        <option value="">Select Warden</option>
                                        <?php if(get_wardenlist_helperfun() && !empty(get_wardenlist_helperfun())){
                                            foreach(get_wardenlist_helperfun() as $warden_val){ ?>
                                                <option value="<?php echo $warden_val->id ?>"><?php echo ucwords($warden_val->name) ?></option>
                                            <?php }
                                        } ?>
                                    </select>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3 d-flex">
                                    <button type="submit" name="save" class="btn btn-submit-request"><?php echo lang('save') ?></button>
                                </div>
                            </div>
                        </div>
                    </form>
...
function savepublicprivate(tb,id,status){
    ...
    console.log('datapost',datapost,urlpath);
    $.ajax({
        url: urlpath,
        type: 'POST',
        data: datapost,
        success: function (data) {
            ...
            console.log('asdasd',divsection_class);
            $('#editmemorypopup').modal('hide');
...
$(document).ready(function(){
    ...
    $('body').on('click','.warden-assign-modal',function(){
        $('#warden-assign-modal').find('.group-title-name').text('Group Name '+$(this).data('groupname'));
        $('#warden-assign-modal').find('input[name=group_id]').val($(this).data('groupid'));
    })
    $('body').on('click','.loadMore_othercommentpost',function(){
        $(this).parent().find('.comment-parent').removeClass('hide');
...
$('#media-uploadnew').validate({
        ...
        submitHandler: function (form) {
            ...
            if ((fileToUpload && fileToUpload != '')) {
                ...
                $(element).find('button[name=submit]').text('Images uploading...');
                // console.log('fileToUpload', fileToUpload);
                var formdata = new FormData(form);
...
/*
    ...
    $('#comment-otherpost').validate({
        ...
        submitHandler: function (form) {
            ...
            let user_id = $(element).find('*[name=user_id]').val();
            $.ajax({
        ...
        $().ready(function() {
            ...
            $('.createprofile').click(function() {
                ...
                $('#createProfile').find('input[name=family_group_id]').val('<?php echo (isset($currect_group_id) && $currect_group_id!='') ? $currect_group_id : $this->uri->segment(2) ?>');
        ...
        if($this->session->flashdata('verifysuccessModal')){ ?>
        <script>
        $(document).ready(function() {
        ...
        function editlife_post(element, type = 'early life', id = '') {
            ...
            $('#lifeof-edit').find('form').find('*[type=submit]').val('Submit');
            $('#lifeof-edit').find('form').find('*[type=submit]').removeAttr('disabled');
...
<script>
    $('.media_slider_submit_form').click(function(e){
        e.preventDefault();
        let element = $(this).closest('form');
        let form_url = $(this).closest('form').attr('action');
        let other_data = $(this).closest('form').serializeArray();
        let user_id = $(element).find('*[name=user_id]').val();
        $.ajax({
            url: form_url,
            type: 'POST',
