      ...
      <div style="width:100%; display:block; text-align: center;">
         ...
         <div style="width: 100%; display: block;background-color:#ffffff; padding:120px 50px 85px 50px; box-sizing: border-box; text-align: left;">
            ...
            <div style="width: 100%; display: block; margin:80px 0 0;">
               <a href="<?php echo site_url('resetpassword/'.$token.'/'.$userTable) ?>" style="display:inline-block;text-decoration: none;font-size: 15px;padding: 20px 35px; background-color:#90a792; color:#ffffff; font-family:Georgia,serif;border-radius: 10px;font-weight: 100;">REST PASSWORD</a>
            </div>
         </div>
      </div>            
   </body>
